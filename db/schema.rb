...
ActiveRecord::Schema[7.0].define(version: 2022_11_11_041338) do
  ...
  create_table "post_type_ships", charset: "utf8mb4", force: :cascade do |t|
    t.bigint "type_id"
    t.bigint "post_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["post_id"], name: "index_post_type_ships_on_post_id"
    t.index ["type_id"], name: "index_post_type_ships_on_type_id"
  end
